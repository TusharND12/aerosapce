...
import { Eye, EyeOff, ArrowRight, Globe, Mail, Lock, Shield } from 'lucide-react'
    ...
    >
      ...
      <div className="space-y-2">
        ...
        <p className="text-gray-400">
          Sign in to access your land intelligence dashboard
        </p>
      </div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between">
            ...
            <Link
              ...
              className="text-sm text-orange hover:text-orange-600 transition-colors"
            >
              Forgot password?
            </Link>
          </div>
      ...
      <p className="text-center text-gray-400">
        ...
        <Link href="/signup" className="text-orange hover:text-orange-600 transition-colors font-medium">
          Request access
        </Link>
      </p>
